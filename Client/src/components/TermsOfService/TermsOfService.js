    ...
    <div className="termsOfService">
      <div className="termsOfService-wrapper">
        <div className="termsOfService-container">
          <HighlightOffIcon className="terms-icon" />
          <h2>
            <strong>Terms and Conditions - Demo Purposes Only</strong>
          </h2>
          <div className="break"></div>
          <p>Welcome to Joshuadinh.Tech!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of JoshuaDin.Tech's Website, located at Joshuadinh.Tech.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Joshuadinh.Tech if you do not
          ...
          <p>
            We employ the use of cookies. By accessing Joshuadinh.Tech, you
            agreed to use cookies in agreement with the JoshuaDin.Tech's Privacy
            Policy.{" "}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, JoshuaDin.Tech and/or its licensors own the
            intellectual property rights for all material on Joshuadinh.Tech.
            All intellectual property rights are reserved. You may access this
            from Joshuadinh.Tech for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Joshuadinh.Tech</li>
            <li>Sell, rent or sub-license material from Joshuadinh.Tech</li>
            <li>Reproduce, duplicate or copy material from Joshuadinh.Tech</li>
            <li>Redistribute content from Joshuadinh.Tech</li>
          </ul>
          <p>
          ...
          <p>
            ...
            JoshuaDin.Tech does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of JoshuaDin.Tech,its agents and/or affiliates.
            ...
            JoshuaDin.Tech shall not be liable for the Comments or for any
          ...
          <p>
            JoshuaDin.Tech reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant JoshuaDin.Tech a non-exclusive license to use,
          ...
          <p>
            ...
            JoshuaDin.Tech; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to JoshuaDin.Tech. Please include your name, your
          ...
          <p>
            No use of JoshuaDin.Tech's logo or other artwork will be allowed for
